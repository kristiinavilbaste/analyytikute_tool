...
export function categoryNamesMatch(canonicalName: string, candidateName: string): boolean {
...
export interface RawQualityCategoryItem {
  id?: string;
  name?: string;
  category?: string;
  score?: number;
...
export interface NormalizedQualityCategory {
  id: string;
  name: string;
  score: number;
  rationale: string;
